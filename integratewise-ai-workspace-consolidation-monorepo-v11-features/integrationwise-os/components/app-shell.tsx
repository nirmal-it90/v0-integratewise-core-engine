...
import { LensSidebar } from "@/components/lens-sidebar"
    ...
    <LensProvider>
      <div className="flex h-screen bg-background">
        ...
        >
          ...
          >
            <LensSidebar onSearchClick={() => setSearchOpen(true)} onAIClick={() => setAiOpen(true)} />
          </div>
        </aside>
          ...
          <header className="h-14 border-b border-border bg-card flex items-center px-4 gap-4">
            ...
            <div className="flex-1 max-w-xl">
              <div className="relative">
                ...
                <Input
                  placeholder="Search across your Spine..."
