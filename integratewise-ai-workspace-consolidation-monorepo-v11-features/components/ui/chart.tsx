...
/**
 * Chart component using IntegrateWise semantic tokens
 *
 * CSS token mapping via globals.css:
 * - Uses chart-1 through chart-5 CSS variables for chart colors
 * - Uses border/muted/background tokens from IntegrateWise palette
 */
